...
data_ids <- read.csv("/Users/mona/Dropbox/Desktop/Tennis_Analytics/tennis_EDA/data_ids.csv")
data_train <- read.csv("/Users/mona/Dropbox/Desktop/Tennis_Analytics/tennis_EDA/data_train.csv")
...
pca_data <- princomp(na.omit(X_train))
...
#Scree plot
#This plot shows the eigenvalues in a downward curve, from highest to lowest. The first two components can be considered to be the most significant since they contain almost 32% of the total information of the data.
