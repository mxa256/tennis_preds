...
#We have to shuffle again and split 
training_data <- rsample::training(data_split)
test_data <- rsample::testing(data_split)

train_rows <- sample(nrow(training_data))
training_data <- training_data[train_rows,]

test_rows <- sample(nrow(test_data))
test_data <- training_data[test_rows,]
...
#MLFlow experiments with SVM Radial Kernel 
```{r}
...
n_rounds_range <- list(100, 200, 300, 500, 1000)
